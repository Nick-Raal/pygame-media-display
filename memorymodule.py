...
class MemoryModule:
    ...
    def __init__(self, screen):
        ...
        self.select_rect = SelectRect(self.mainmenu_buttons[1].get_rect().left - 30, self.mainmenu_buttons[0].get_rect().top, 20, 50, self.mainmenu_buttons[0].get_rect().center + (self.mainmenu_buttons[0].get_rect().width, 0))
