...
class MemoryModule:
    ...
    def drawing_handler(self):
        ...
        if not self.has_drawn:
            ...
            return [pygame.Rect(self.select_rect.left, self.select_rect.top, self.select_rect.right - self.select_rect.target.get_rect().right, self.select_rect.top - self.select_rect.target.get_rect().top),]
