...
class MemoryModule:
    ...
    def __init__(self, screen):
        ...
        self.select_rect = SelectRect(self.mainmenu.get_widest_button().left - 30, self.mainmenu.buttons[0].get_rect().top, 20, 50, self.mainmenu_buttons[0].get_rect().centery)
